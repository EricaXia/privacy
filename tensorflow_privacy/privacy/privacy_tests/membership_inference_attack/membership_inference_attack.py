...
def _run_trained_attack(
    ...
    attacker.train_model(
        prepared_attacker_data.features_train,
    ...
    clf_report = metrics.classification_report(
        y_true=prepared_attacker_data.is_training_labels_test,
...
def _run_attack(
    ...
    if attack_type.is_trained_attack:
        return _run_trained_attack(attack_input, attack_type, balance_attacker_training)
